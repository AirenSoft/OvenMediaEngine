...
TranscodeResult TranscoderStream::EncodeFrame(int32_t filter_id, std::shared_ptr<const MediaFrame> frame)
{
...
cmn::MediaCodecId TranscoderStream::GetCodecId(ov::String name)
{
	name.MakeUpper();
