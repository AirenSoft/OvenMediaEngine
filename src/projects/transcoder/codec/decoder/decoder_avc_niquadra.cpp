...
//
//==============================================================================
#include "decoder_avc_niquadra.h"
...
bool DecoderAVCxNIQUADRA::Configure(std::shared_ptr<MediaTrack> context)
{
...
bool DecoderAVCxNIQUADRA::InitCodec()
{
	const AVCodec *_codec = ::avcodec_find_decoder_by_name("h264_ni_quadra_dec");
	if (_codec == nullptr)
	{
