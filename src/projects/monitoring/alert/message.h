	...
	namespace alrt
	{
		...
		public:
			...
			enum class Code : uint32_t
			{
				...
				INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_OUTPUT_PROFILE,
				INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_DECODER, 
				INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_ENCODER, 
				INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_FILTER,
				...
				INGRESS_TRANSCODE_DECODING_FAILED,
			...
			static ov::String StringFromMessageCode(Code message_code)
			{
				switch (message_code)
				{
					...
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_DECODER, "INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_DECODER");
					OV_CASE_RETURN(Code::INGRESS_TRANSCODE_DECODING_FAILED, "INGRESS_TRANSCODE_DECODING_FAILED");
					...
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_OUTPUT_PROFILE, "INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_OUTPUT_PROFILE");
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_ENCODER, "INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_ENCODER");
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_FILTER, "INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_FILTER");
			...
			static ov::String DescriptionFromMessageCode(Code message_code, T config_value, T measured_value)
			{
				...
				switch (message_code)
				{
					...
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_OUTPUT_PROFILE, "Failed to create egress stream because the output profile configuration is invalid");
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_DECODER, "Failed to create stream because the decoder for the ingress stream could not be created");
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_ENCODER, "Failed to create egress stream because the encoder could not be created");
					OV_CASE_RETURN(Code::INGRESS_OUTPUT_STREAM_CREATION_FAILED_BY_FILTER, "Failed to create egress stream because the filter could not be created");
					...
					OV_CASE_RETURN(Code::INGRESS_TRANSCODE_DECODING_FAILED, "Failed to decode frames for the ingress stream");
