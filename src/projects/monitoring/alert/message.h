...
namespace mon::alrt
{
	...
	public:
		...
		constexpr static const uint32_t ANOMALY_CODE_MASK		 = 0x180000;
...
#ifdef OME_ENTERPRISE
				OV_CASE_RETURN_ENUM_STRING(Code, ANOMALY_DTS_REVERSAL_DETECTED);
				OV_CASE_RETURN_ENUM_STRING(Code, ANOMALY_DTS_DUPLICATION_DETECTED);
				OV_CASE_RETURN_ENUM_STRING(Code, ANOMALY_DTS_JUMP_DETECTED);
				OV_CASE_RETURN_ENUM_STRING(Code, ANOMALY_PACKET_TIMEOUT_DETECTED);
#endif	// OME_ENTERPRISE
			}
