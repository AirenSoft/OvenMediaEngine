...
public:
	...
	bool TerminateSession(uint32_t session_id);
...
protected:
	...
	// TODO(Getroot): Delete this code after implement OnDatagramReceived()
...
private:
	// Get IcePortInfo
	std::shared_ptr<IcePortInfo> FindIcePortInfo(uint32_t session_id);
