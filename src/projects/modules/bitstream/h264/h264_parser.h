...
private:
    ...
    uint32_t _num_slice_groups_minus1;
    uint8_t _deblocking_filter_control_present_flag;
    bool _entropy_coding_mode_flag;
	bool _bottom_field_pic_order_in_frame_present_flag;
	uint8_t _redundant_pic_cnt_present_flag;
    uint32_t _num_ref_idx_l0_default_active_minus1;
    uint32_t _num_ref_idx_l1_default_active_minus1;

    uint8_t _weighted_pred_flag;
    uint8_t _weighted_bipred_idc;
...
private:
    ...
    uint32_t _num_ref_idx_l0_active_minus1;
    uint32_t _num_ref_idx_l1_active_minus1;
