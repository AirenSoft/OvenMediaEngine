...
namespace info
{
	...
	public:
		CodecModule() = delete;
		CodecModule(const ov::String &display_name, cmn::MediaType media_type, cmn::MediaCodecModuleId module_id, cmn::DeviceId device_id, const ov::String &bus_id, const std::vector<cmn::MediaCodecId> &supported_codecs, bool is_decoder, bool is_encoder, bool is_hwaccel)
