...
std::shared_ptr<Certificate> Publisher::GetCertificate(ov::String cert_path, ov::String key_path)
{
	if(
...
std::shared_ptr<Certificate> Publisher::GetChainCertificate(ov::String chain_cert_path)
{
	if(
