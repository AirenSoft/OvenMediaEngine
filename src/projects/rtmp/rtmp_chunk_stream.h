...
{
public:
	virtual bool OnChunkStreamReadyComplete(ov::ClientSocket *remote, ov::String &app_name, ov::String &stream_name, std::shared_ptr<RtmpMediaInfo> &media_info, info::application_id_t &applicaiton_id, uint32_t &stream_id) = 0;
	virtual bool OnChunkStreamVideoData(ov::ClientSocket *remote, info::application_id_t applicaiton_id, uint32_t stream_id, uint32_t timestamp, std::shared_ptr<std::vector<uint8_t>> &data) = 0;
	virtual bool OnChunkStreamAudioData(ov::ClientSocket *remote, info::application_id_t applicaiton_id, uint32_t stream_id, uint32_t timestamp, std::shared_ptr<std::vector<uint8_t>> &data) = 0;
	virtual bool OnChunkStreamDelete(ov::ClientSocket *remote, ov::String &app_name, ov::String &stream_name, info::application_id_t applicaiton_id, uint32_t stream_id) = 0;
};
...
protected :
	...
	info::application_id_t _applicaiton_id;
