...
private :
	...
	bool        OnPlayListRequest(const ov::String &app_name, const ov::String &stream_name, const ov::String &file_name, PlayListType play_list_type, ov::String &play_list) override;
	...
	bool        OnCorsCheck(const ov::String &app_name, const ov::String &stream_name, const ov::String &file_name, ov::String &origin_url) override;
