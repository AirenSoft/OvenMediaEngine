...
{
public:
	static std::shared_ptr<MediaRouteApplication> Create(std::shared_ptr<ApplicationInfo> appinfo);

    MediaRouteApplication(std::shared_ptr<ApplicationInfo> appinfo);
    ~MediaRouteApplication();
...
public:
	...
	public:
		BufferIndicator(uint32_t stream_id) {
