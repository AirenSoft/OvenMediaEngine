...
GLOBAL_LDFLAGS_RELEASE := -Wl,-rpath,/opt/ovenmediaengine/lib,-rpath,/opt/ovenmediaengine/lib64 -O3 $(GLOBAL_LDFLAGS_COMMON)

GLOBAL_CFLAGS_DEBUG := -g -DDEBUG -D_DEBUG $(GLOBAL_CFLAGS_COMMON)
GLOBAL_CXXFLAGS_DEBUG := -g -DDEBUG -D_DEBUG $(GLOBAL_CXXFLAGS_COMON)
GLOBAL_LDFLAGS_DEBUG := -Wl,-rpath,/opt/ovenmediaengine/lib,-rpath,/opt/ovenmediaengine/lib64 $(GLOBAL_LDFLAGS_COMMON)
